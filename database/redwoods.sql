...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2018 at 12:57 AM
...
INSERT INTO `users` (`pin`, `username`, `password`, `name`, `email`, `contact`, `usertype`, `img`, `created_at`, `updated_at`, `is_deleted`) VALUES
